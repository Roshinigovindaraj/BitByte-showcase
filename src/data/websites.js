...
export const categoryDesigns = {
  ...
  textile: {
    ...
    designs: [
      ...
      { id:7, name:"Bulk Quote",        style:"B2B Quote Flow",          image:"assets/site-7.png", desc:"Quote request UI with sampling flow, bulk ordering pages, and fast lead capture sections for B2B clients.",           previewUrl:"https://preview..net/item/marketo-multipurpose-ecommerce-html-template/full_screen_preview/24433889",   tags:["B2B","Quotes","Bulk"],             badge:"Trusted",      badgeColor:"bg-cyan-100 text-cyan-700" },
    ],
  },
